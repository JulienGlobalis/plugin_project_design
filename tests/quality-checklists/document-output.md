...
- [ ] The document uses only validated input artefacts.
...
`TO BE DEFINED`: assembly order, localization resolution, template selection,
cross-document reconciliation, exporter behavior, and approved output
templates.
