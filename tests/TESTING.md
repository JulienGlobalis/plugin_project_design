...
1. Read `README.md`, `PLAN.md`, `SPEC.md`, `CHANGELOG.md`, and
   `CONTRIBUTING.md`.
...
9. Record the test run and update repository documentation.
10. Never modify a golden output without explicit human approval.
...
temporary test-run location, must not be committed under `tests/fixtures/`,
and must be deleted after its evidence has been recorded.
